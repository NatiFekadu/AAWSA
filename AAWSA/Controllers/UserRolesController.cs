...
namespace AAWSA.Controllers
{
    public class UserRolesController : Controller
    {
        ...
        public UserRolesController(UserManager<AAWSAUser> userManager, RoleManager<IdentityRole> roleManager)
        {
        ...
        private async Task<List<string>> GetUserRoles(AAWSAUser user)
        {
